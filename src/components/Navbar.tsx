...
function Navbar() {
  return (
    <nav className="bg-black/95 backdrop-blur-sm h-[10%] w-[75%] mx-auto mt-3 rounded-full shadow-[0_2px_8px_rgba(0,0,0,0.3)] transition-transform duration-300 hover:scale-[1.01]">
